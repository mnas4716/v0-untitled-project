        ...
        <div className="container max-w-md">
          <Card className="border-0 shadow-lg">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardTitle className="text-2xl font-bold">Prescription Request Submitted</CardTitle>
              <CardDescription>
                Thank you for your prescription request. We will process your request shortly.
              </CardDescription>
            </CardHeader>
