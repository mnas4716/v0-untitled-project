...
export async function verifyOTP(email: string, otp: string) {
  ...
  try {
    ...
    // Verify OTP against stored value and check expiration
    const isValidOTP = storedOTPData && storedOTPData.otp === otp && new Date() <= storedOTPData.expires
    ...
    if (isValidOTP) {
      ...
      return {
        ...
        message: storedOTPData
          ? new Date() > storedOTPData.expires
