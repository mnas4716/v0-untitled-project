...
const trustBadges = [
  ...
  { icon: <CheckCircle2 className="h-5 w-5 text-freedoc-blue mr-2" />, text: "Accepted Australia-Wide" },
  { icon: <CheckCircle2 className="h-5 w-5 text-freedoc-blue mr-2" />, text: "Secure & Confidential" },
...
const usesOfCertificate = [
  { icon: <Briefcase className="h-6 w-6 text-freedoc-blue mr-3" />, text: "Absence from Work" },
  { icon: <GraduationCap className="h-6 w-6 text-freedoc-blue mr-3" />, text: "Absence from University or School" },
  { icon: <Baby className="h-6 w-6 text-freedoc-blue mr-3" />, text: "Carer's Leave (for family members)" },
  { icon: <CheckCircle2 className="h-6 w-6 text-freedoc-blue mr-3" />, text: "Other general purpose leave" },
]
...
const whyChooseFreedocMc = [
  ...
  {
    icon: <CheckBadge className="h-10 w-10 text-freedoc-blue mb-3" />,
    ...
    <div className="bg-white text-freedoc-dark">
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-freedoc-dark mb-4">How to Get Your Medical Certificate</h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
            {usesOfCertificate.map((use) => (
              ...
              >
                {use.icon}
                <span className="text-freedoc-dark ml-3">{use.text}</span>
              </div>
            ))}
          </div>
        </div>
